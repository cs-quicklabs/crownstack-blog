---
title: "Crownstack's PHP and Laravel code guidelines"
date: '2022-12-24'
lastmod: '2022-12-24'
tags: ['engineering', 'training', 'laravel']
draft: false
summary: "This is Crownstack's official guideline for PHP and Laravel best coding practices."
layout: PostSimple
images: []
authors: ['varun-kumar']
---

![Laravel Logo](/static/images/blogs/web/laravel-logo.png)

## About Laravel

First and foremost, Laravel provides the most value when you write things the way Laravel intended you to write. If there's a documented way to achieve something, follow it. Whenever you do something differently, make sure you have a justification for _why_ you didn't follow the defaults.
...
```
https://www.crownstack.com/contact-us
https://www.crownstack.com/jobs/senior-laravel-developer
```
