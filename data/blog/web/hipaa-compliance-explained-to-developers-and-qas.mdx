...
| --------------------------------------------- | ------------------------ |
| Did not know (unintentional, no way to avoid) | Upto $50,000 |
| Reasonable cause (knew or should have known)  | Upto $50,000 |
| Willful neglect (corrected in time) | Upto $50,000 |
| Willful neglect (not corrected) | Upto $50,000 |
