...
date: '2024-01-11'
lastmod: '2024-01-11'
tags: ['cloud functions', 'firestore', 'algolia']
draft: false
...
![backend-services.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/backend-services.png)
...
![truora.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/truora.png)
...
![algolia.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/algolia.png)
...
![twilio.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/twilio.png)
...
![slack.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/slack.png)

### Integrations

![integrations.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/integrations.png)
...
![authentication.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/authentication.png)
...
![whatsapp.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/whatsapp.png)
...
![ci_cd.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/ci_cd.png)
...
We decided to create a **KANBAN BOARD f**or the admin in order to visualize the Driver Application in Various stages. In order to visualize this data we wanted some tool that would make our life easier to filter this according to the attributes we need without too much complications.
...
![kanban.png](crafting-a-full-stack-serverless-application-using-google-cloud-functions-firestore-and-algolia/kanban.png)
