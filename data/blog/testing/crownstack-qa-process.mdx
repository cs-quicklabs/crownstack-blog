...
A sample of test plan we follow at Crownstack: [Test Plan](https://drive.google.com/file/d/1Hbavp3TuRglhqTs0z8bIgGJCTRCOXE8j/view?usp=share_link)
...
/static/images/blogs/testing/crownstack-qa-process/guideline-to-write-effective-test-cases.png
...
For Bug reporting, we use **“Jira”** and below is the guideline/format to log bugs in it : [Bug Reporting Template](https://drive.google.com/drive/u/0/folders/11uxWAzFR6jKE14l-ADxMEUTiWxdlxr2B).
...
We have a defined format for test reports here at Crownstack - [Sample Test Report](https://drive.google.com/drive/u/0/folders/11uxWAzFR6jKE14l-ADxMEUTiWxdlxr2B)
...
We have defined a format for the same and we called it BCR at Crownstack(Build Completion Report) [BCR Format](https://support.google.com/googleplay/answer/7431675?hl=en-GB)
