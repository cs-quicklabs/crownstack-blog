...
![View performance of a Postman collection run](/static/images/blogs/testing/performance-testing-of-apis/view-performance-of-Postman-collection.png)
...
![View request and response times of Postman run collection](/static/images/blogs/testing/performance-testing-of-apis/request-and-response-times.png)

**Step 8**. Once the run is completed, observe and identify bottlenecks in response times and requests per second:

![identify bottlenecks](/static/images/blogs/testing/performance-testing-of-apis/identify-bottlenecks.png)
