---
title: 'Creating Test Plans - Best Practices'
date: '2023-03-04'
lastmod: '2023-03-04'
tags: ['qa', 'process']
draft: false
...
![What is test plan workflow?](/static/images/blogs/qa/crownstack-test-plan-workflow/what-is-test-plan-workflow.png 'What is test plan workflow?')
...
![In-scope testing](/static/images/blogs/qa/crownstack-test-plan-workflow/in-scope-testing.png 'In-scope testing')

#### Out-of-scope testing

![Out-of-scope testing](/static/images/blogs/qa/crownstack-test-plan-workflow/out-of-scope-testing.png 'Out-of-scope testing')
...
![Tools and technologies](/static/images/blogs/qa/crownstack-test-plan-workflow/tools-and-technologies.jpg 'Tools and technologies')
...
By doing this, we can make sure that the software we are working on is of good quality and works well. For bug reporting, we use “Jira” and below is the guideline/format to log bugs in it: [Bug Reporting Template](/static/assets/blogs/qa/crownstack-test-plan-workflow/Bug-Reporting-Template.pdf)
...
![Roles and responsibilities](/static/images/blogs/qa/crownstack-test-plan-workflow/roles-and-responsibilities.png 'Roles and responsibilities')
...
![Test deliverables](/static/images/blogs/qa/crownstack-test-plan-workflow/test-deliverables.png 'Test deliverables')
