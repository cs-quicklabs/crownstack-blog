...
- It utilizes standard HTTP methods (_GET, POST, PUT, DELETE_) to perform operations on resources.
...
- SOAP APIs are based on XML (_eXtensible Markup Language_) for message formatting.
...
![Performance testing of APIs](/static/images/blogs/qa/performance-testing-of-apis-using-postman/performance-testing-of-an-API.png)
...
![Select a Postman collection](/static/images/blogs/qa/performance-testing-of-apis-using-postman/select-a-postman-collection.png)

**Step 2.** Select an environment and click on run:

![Select a Postman environment](/static/images/blogs/qa/performance-testing-of-apis-using-postman/select-a-postman-environment.png)

**Step 3.** Create a request on the Postman collection:

![Create a request on the Postman collection](/static/images/blogs/qa/performance-testing-of-apis-using-postman/create-a-request-in-postman-collection.png)

**Step 4.** Go to the collection and select the Run collection:

![Go to the collection and select the Run collection](/static/images/blogs/qa/performance-testing-of-apis-using-postman/run-a-postman-collection.png)

**Step 5.** Go to the performance section on the right side:

![View performance of a Postman collection run](/static/images/blogs/qa/performance-testing-of-apis-using-postman/view-performance-of-Postman-collection.png)
...
![View request and response times of Postman run collection](/static/images/blogs/qa/performance-testing-of-apis-using-postman/request-and-response-times.png)

**Step 8**. Once the run is completed, observe and identify bottlenecks in response times and requests per second:

![identify bottlenecks](/static/images/blogs/qa/performance-testing-of-apis-using-postman/identify-bottlenecks.png)
