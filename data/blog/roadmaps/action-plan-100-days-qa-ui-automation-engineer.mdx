...
## Week 1: Setting up your machine, know our processes and learning programs & revising Git
...
3. Get familiar with the process of filling in Timesheets & WSR (Weekly Status Report) - our HR team should guide you on these
...
## Week 2: Complete revising Git & Git evaluation

In the second week, you will complete revising Git with practice. This week is crucial for building a strong foundation in version control. Once done, please also go through the following blog articles on Git workflows and best practices we follow at Crownstack:
...
## Week 3 and 4: Basics of HTML, CSS & JavaScript & evaluation
...
## Week 5: Get familiar with TypeScript
...
## Week 6 and 7: Understanding Playwright Basics & TypeScript Evaluation

In week 6 we will do another evaluation on TypeScript to assess your understanding and proficiency.
...
## Week 8 and 9: Playwright Advanced Concepts & Playwright Evaluation

To be added later.


## Week 10: Playwright Evaluation

In the tenth week, we will conduct a comprehensive evaluation on Playwright to assess your understanding and proficiency in using Playwright for UI automation testing. This evaluation will cover all the topics you have learned so far and will help us identify any areas that may need further improvement.