...
3. Go through and understand [Crownstack's QA Process and best practices](https://blog.crownstack.com/blog/qa/crownstack-qa-process). Please take help from your team lead to understand the QA process in detail
4. Get familiar with the process of filling in Timesheets & WSR (Weekly Status Report) - your team lead should guide you on these
...
We have created a dedicated course on [Quick Learn](https://learn.quicklabs.in) where we cover all the topics listed below as small chapters in our course [Git Fundamentals and Advanced topics](https://learn.quicklabs.in/dashboard/content/course/6).

If you cannot access the above course on [Quick Learn](https://learn.quicklabs.in), we recommend you to go through this excellent book on Git: [Ry's Git Tutorial](https://www.amazon.in/Rys-Git-Tutorial-Ryan-Hodson-ebook/dp/B00QFIA5OC).

We are dividing the topics mentioned in this book into high, medium and low priority topics. You should go through the high priority topics in the first and second week, and then low priority topics can be covered whenever needed in your project.
...
After that, we will start learning Playwright. Please go through the [Crownstack's Playwright Basics Guide](https://blog.crownstack.com/blog/fls/playwright-basics) to get started with Playwright. This guide will cover the basics of Playwright, including how to set up your environment, understanding Playwright's architecture and its core concepts.



## Week 9 and 10: Playwright Advanced Concepts

Once you are done with the basics of Playwright, we will move on to advanced concepts in Playwright. Please go through the [Crownstack's Playwright Advanced Concepts](https://blog.crownstack.com/blog/fls/playwright-advanced) guide to learn about advanced features and techniques in Playwright.
