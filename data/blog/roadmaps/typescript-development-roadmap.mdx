...
draft: false
summary: 'A roadmap to learn Typescript, all the important topics for Typescript.'
layout: PostSimple
images: []
authors: ['varun-kumar']
---

# TypeScript Learning Roadmap & Assignments
...
- [Level 1: Basics of Typescript](#typescript-installation)
- [Level 2: Type Inference](#type-inference)
- [Level 3: Interfaces and Type Aliases](#interfaces-and-type-aliases)
- [Level 4: Type Compatibility](#type-compatibility)
- [Level 5: Functions and Type Inference](#functions-and-type-inference)
- [Level 6: Classes and Inheritance](#classes-and-inheritance)
- [Level 7: Modules and Namespaces](#modules-and-namespaces)
- [Level 8: Generics](#generics)
- [Level 9: Advanced Types](#advanced-types)
- [Level 10: Type Assertions](#type-assertions)
- [Level 11: Global Augmentation](#global-augmentation)
- [Level 12: Utility Types](#utility-types)
- [Level 13: Mapped Types](#mapped-types)
- [Level 14: Integrating TypeScript with Frameworks](#integrating-typescript-with-frameworks)
...
1. [https://roadmap.sh/typescript](https://roadmap.sh/typescript)
